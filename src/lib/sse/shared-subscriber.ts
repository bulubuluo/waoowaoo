...
type GlobalSharedSubscriber = typeof globalThis & {
  __plotweaveSharedSubscriber?: SharedSubscriber
}

const globalForSharedSubscriber = globalThis as GlobalSharedSubscriber

export function getSharedSubscriber() {
  if (!globalForSharedSubscriber.__plotweaveSharedSubscriber) {
    globalForSharedSubscriber.__plotweaveSharedSubscriber = new SharedSubscriber()
  }
  return globalForSharedSubscriber.__plotweaveSharedSubscriber
}
